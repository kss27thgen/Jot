    ...
    <div class="w-96 bg-blue-900 rounded-lg shadow-xl p-6">
        ...
        <form method="POST" action="{{ route('login') }}" class="pt-8">
            ...
            <div class="relative">
                ...
                <div>
                    <input id="email" type="email" class="pt-8 w-full rounded p-3 bg-blue-800 text-gray-100 outline-none focus:bg-blue-700" name="email" value="{{ old('email') }}" autocomplete="off"  autofocus placeholder="your@email.com">
            ...
            <div class="relative pt-3">
                ...
                <div class="">
                    <input id="password" type="password" class="pt-8 w-full rounded p-3 bg-blue-800 text-gray-100 outline-none focus:bg-blue-700" name="password" value="{{ old('password') }}" autocomplete="off"  autofocus placeholder="your password">
            ...
            <div class="pt-8">
                <button type="submit" class="uppercase rounded font-bold text-blue-800 w-full bg-gray-400 py-2 px-3 text-left">
                    Login
                </button>
            </div>
